...
class LeagueController extends Controller
{
    ...
    public function show(League $league): Response
    {
        $league->load([
            ...
            'entries.player2',
            'entries.substitutes',
            'groups.groupEntries.entry.team',
