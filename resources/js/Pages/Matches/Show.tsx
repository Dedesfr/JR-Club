            ...
            <main className="mx-auto flex max-w-md flex-col gap-6 px-4">
                ...
                <section className="flex flex-col gap-4 rounded-lg bg-surface-container-low p-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div><p className="text-sm font-bold tracking-tight text-on-surface">Main Court</p><p className="text-[0.6875rem] font-medium text-on-surface-variant">{new Date(match.scheduled_at).toLocaleString()}</p></div>
                    </div>
                    <div className="flex items-center gap-3">
